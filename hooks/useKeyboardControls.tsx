...
//   // New effect for checking pointer lock state
//   React.useEffect(() => {
//     const checkPointerLock = () => {
//       if (document.pointerLockElement) {
//         // Reset all controls to false
//         const resetState = Object.keys(api[1]()).reduce((acc, key) => {
//           acc[key] = false;
//           return acc;
//         }, {} as KeyboardControlsState);
//         set(resetState);

//         // Inform callback if provided
//         if (onChange) {
//           Object.keys(resetState).forEach((name) => {
//             onChange(name, false, resetState);
//           });
//         }
//       }
//     };
...
//     // Add event listener for pointerlockchange
